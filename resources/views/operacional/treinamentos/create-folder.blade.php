<x-app-layout>
    ...
    <div class="row mb-3 align-items-center">
        <div class="col">
            <h2 class="page-title">Nova Pasta de Treinamento</h2>
        </div>
        <div class="col-auto">
            <a href="{{ route('operacional.treinamentos.index') }}" class="btn btn-secondary">Cancelar</a>
        </div>
    </div>

    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('operacional.treinamentos.pastas.store') }}">
                @csrf
                <div class="mb-3">
