<x-app-layout>
    ...
    <div class="row mb-3 align-items-center">
        <div class="col">
            ...
            <p class="text-muted mt-1">{{ $curso->titulo }}</p>
        </div>
        <div class="col-auto">
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('operacional.universidade.update', $curso) }}" enctype="multipart/form-data">
                @csrf @method('PUT')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="status" class="form-select" required>
                            ...
                            <option value="arquivado" {{ old('status', $curso->status) === 'arquivado' ? 'selected' : '' }}>Arquivado</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="instrutor" class="form-control"
                               value="{{ old('instrutor', $curso->instrutor) }}">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="clinic_id" class="form-select">
                            ...
                            <option value="{{ $clinic->id }}" {{ old('clinic_id', $curso->clinic_id) == $clinic->id ? 'selected' : '' }}>
                                {{ $clinic->name }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="descricao" rows="4" class="form-control">{{ old('descricao', $curso->descricao) }}</textarea>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Thumbnail (deixe em branco para manter)</label>
                        @if($curso->thumbnail_path)
                        <div class="mb-2">
                            <img src="{{ Storage::url($curso->thumbnail_path) }}" class="img-fluid rounded" style="max-height:120px;">
                        </div>
                        @endif
