<x-app-layout>
    ...
    <form method="POST" action="{{ route('crm.clientes.store') }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="tipo" class="form-select @error('tipo') is-invalid @enderror" required>
                            ...
                            <option value="lead"    {{ old('tipo') === 'lead' ? 'selected' : '' }}>Lead</option>
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="telefone" value="{{ old('telefone') }}"
                               class="form-control @error('telefone') is-invalid @enderror" placeholder="(00) 00000-0000" required>
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-2">
                        ...
                        <input type="text" name="cep" value="{{ old('cep') }}" class="form-control" placeholder="00000-000">
                    </div>
                    <div class="col-md-5">
        ...
        <div class="d-flex justify-content-end gap-2">
            <a href="{{ route('crm.clientes.index') }}" class="btn btn-secondary">Cancelar</a>
